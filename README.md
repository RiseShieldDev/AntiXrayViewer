...
🔍 **AntiXrayViewer** - Лучший плагин против читеров X-Ray для Minecraft Paper 1.21.11 | Anti X-Ray | Античит | Защита от читов
...
Продвинутая система обнаружения и записи подозрительной активности игроков для Minecraft Paper 1.21.11.
...
### v1.2.2 - Обновление до Paper 1.21.11 (03.02.2026)
- ✅ **Обновлён Paper API до 1.21.11** - полная совместимость с последней версией Paper
- ✅ **Протестирован на Paper 1.21.11-69 (stable)** - стабильная работа на стабильной версии сервера

### v1.2.1 - Обновление версии для релиза
- ✅ Подготовка к публикации на GitHub Releases
